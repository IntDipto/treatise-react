...
function BlogContent({post}) {
  ...
  return (
    <div>
        ...
        {/* <!-- description area  --> */}
        <div className="mt-10">
            <img src={require(`./../../assests/images/Single-blog/${post?.titleOneImg}.webp`)} alt="" srcSet=""/>
            <div className="mt-10">
            ...
            {/* <!-- 2nd image  --> */}
            <div className="mt-6 sm:mt-10">
                <img src={require(`./../../assests/images/Single-blog/blog-image-2.webp`)} alt="" srcSet=""/>
            </div>
