...
import banner from '../../assests/images/home/banner.png'
import bannerMobile from '../../assests/images/home/banner-m.png'
  ...
  return (
    <div className="banner mx-4 sm:mx-6 lg:mx-20 2xl:mx-[182px] flex flex-col lg:flex-row lg:items-start xl:items-center justify-between ">
            ...
            <div className="w-[100%] lg:w-[39%] mt-6 lg:mt-0">
                <img className="rounded-[16px] w-full hidden lg:block" src={banner} alt="" srcSet=""/>
                <img className="rounded-[16px] w-full block sm:hidden" src={bannerMobile} alt="" srcSet=""/>
            </div>
