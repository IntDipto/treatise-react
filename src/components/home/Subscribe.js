        ...
        <div className="subscribe mt-10" style={{"backgroundImage" : `url(${bg})`}}>
            <div className="px-4 lg:px-[150px] 2xl:px-[15%] py-[80px]">
                <div className="flex flex-col lg:flex-row items-center gap-[80px] gap-x-[100px] xl:gap-x-[198px]">
                    ...
                    <div className="">
                        <Link to="/subscribe-membership"><button className="px-[80px] sm:px-[100px] py-[13px] bg-white text-text rounded-[10px] whitespace-nowrap text-sm ">Become a Member</button></Link>
                    </div>
                </div>
            </div>
        </div>
