...
function Card() {
    ...
    useEffect(()=>{
        axios.get('../data/membership/memberShipCard.json').then((response) =>{
                  ...
                  <div key={i} className="w-[300px] py-6 px-2 rounded-[10px] border-0 sm:border mt-6 membership-table">
                    ...
                    <div className="mt-6 flex flex-col gap-4 ">
                        ...
                        <div className="flex justify-center mt-6">
                            <Link to='/subscribe-membership'><button className="text-text text-sm px-10 py-3 border border-text rounded-[7px]">Start Now</button></Link>
                        </div>
                    </div>
                  </div>  
                )
