    ...
    <div>
        <div id="profile" className="mx-4 md:mx-[15%]">
            ...
            <div className="px-2 sm:px-4 py-4 person-details rounded-[6px] w-full relative">
                ...
                <div id="profile-info" className={`${displayInfo === "info"? 'block' : 'hidden'}`}>
                ...
                {/* <!-- profile editing  --> */}
                <div id="profile-edit" className={`${displayInfo === "editInfo"? 'block' : 'hidden'}`}>
                    <div className="flex justify-center">
                        <form className="py-0 sm:py-8 w-full sm:w-[610px] flex flex-col gap-y-6">
                            ...
                            <div className="flex flex-col sm:flex-row items-start sm:items-center w-full">
                                <label className="w-[160px] block text-sm font-bold text-text" htmlFor="name">Social Media</label>
                                <input className="mt-2 sm:mt-0 p-3 border border-text-10 w-full sm:w-[450px] text-sm font-bold placeholder:text-primary-80 outline-none rounded-[4px]" type="text" name="" id="name" placeholder="{{url}}"/>
                            </div>
                                ...
                                <div className="flex flex-col gap-y-2">
                                    {inputList.length > 0 ? inputList.map((input, index) => (
                                        <div key={index} className="relative">
                                            ...
                                            <button className='absolute top-1/2 -translate-y-1/2 right-3' onClick={() => handleRemoveItem(index)}>
                            ...
                            <div className="flex flex-col sm:flex-row w-full justify-start">
                                <label className="w-[160px] block text-sm font-bold text-text" htmlFor="name">Interested In</label>
                                <div className="mt-2 sm:mt-0 tags-input-wrapper w-full sm:w-[450px] p-3 border border-text-10 text-sm rounded-[4px]">
                ...
                {/* <!-- Edit password  -->  */}
                <div id="edit-password" className={`${displayInfo === "editPassword"? 'block' : 'hidden'}`}>
                    <div className="flex justify-center">
                        <form className="py-0 sm:py-8 w-full sm:w-[610px] flex flex-col gap-y-6">
