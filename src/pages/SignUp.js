    ...
    <div  style={{"backgroundImage":`url(${bg})`}} className="h-full ">
        <div className="flex justify-center py-[80px] sm:py-[160px] h-full">
            <div className="w-[450px] mx-4 sm:mx-0 py-6 sm:py-8 px-4 sm:px-6 bg-white rounded-[10px] form-container h-fit">
                ...
                <p className="mt-4 text-text-60 text-sm sm:text-base leading-[17px] sm:leading-[20px]">Already have and account? <span className="text-primary/90"><Link to='/login'>Sign in</Link></span></p>
